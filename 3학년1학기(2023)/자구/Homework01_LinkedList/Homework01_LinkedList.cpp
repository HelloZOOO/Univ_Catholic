...
Position Insert(ElementChar name, ElementType X, ElementStatus Status, List L, Position P);  // 노드 삽입
...
// ================================ 노드 삽입 함수 =======================================
Position Insert(ElementChar name, ElementType X, ElementStatus Status, List L, Position P) {
    // P -> P2
...
int main() {
    ...
    cout << ">>> 아무값도 출력되지 않으면 1값을 가진 스테이터스들이 삭제된것입니다." << endl;;
